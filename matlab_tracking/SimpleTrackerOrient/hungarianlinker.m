...
% implementing the Munkres algorithm; this file is merely a wrapper for it.
    ...
    %weight of angle distance, global variable //modified by EK
    global coeff_angle;
    ...
    for i = 1 : n_source_points
        ...
        diff_coords(:,3)=abs(diff_coords(:,3));
        filt=diff_coords(:,3)>90*coeff_angle;
        diff_coords(filt,3)=180*coeff_angle-diff_coords(filt,3);
